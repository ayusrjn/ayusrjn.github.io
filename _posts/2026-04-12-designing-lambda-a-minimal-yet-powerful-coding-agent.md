...
## How Lambda Works
![Lambda Agent Loop](img/lambda_agent_loop.svg)
...
![Lambda Memory System](img/lambda_memory_system.svg)
...
![Lambda Subagent Isolation](img/lambda_subagent_isolation.svg)
...
![Lambda Search Vs Read](img/lambda_search_vs_read.svg)
